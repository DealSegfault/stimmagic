/**
 * Sobel gradient map — the magnetic lasso reads edges from this.
 *
 * COPIED from packages/image-editor/src/plugins/retouch/utils/edgeDetection.ts (2026-07-27), with its
