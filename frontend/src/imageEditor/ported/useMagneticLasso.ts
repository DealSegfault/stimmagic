/**
 * Magnetic lasso session state over the live-wire search.
 *
 * COPIED from packages/image-editor/src/plugins/retouch/composables/useMagneticLasso.ts (2026-07-27), with its
...
import { computeGradientMap, type GradientMap } from './edgeDetection';
import { findOptimalPath, simplifyPath, type LivewireConfig, DEFAULT_LIVEWIRE_CONFIG } from './livewire';
