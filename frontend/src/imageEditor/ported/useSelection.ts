/**
 * The selection model: one mask, combine modes, feather, marching ants.
 *
 * COPIED from packages/image-editor/src/plugins/retouch/composables/useSelection.ts (2026-07-27), with its
