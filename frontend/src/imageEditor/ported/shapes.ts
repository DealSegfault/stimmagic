 ...
 * text layout and measurement, redaction, hit testing, resize handles and
 * bounds. This is the single largest body of solved product work in the old
 * editor and there is no version of rewriting it that comes out better.
 */
/**
 * Shape rendering utilities
 */
import type { Shape, PathShape, LineShape, CurvedArrowShape, RectangleShape, EllipseShape, TextShape, RedactShape, TriangleShape, StarShape, PolygonShape, ResizeHandle } from './shapeTypes';
