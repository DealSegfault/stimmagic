/**
 * Selection mask operations: rect/ellipse/lasso fills, flood fill, feather, invert, bounds, marching-ants path.
 *
 * COPIED from packages/image-editor/src/plugins/retouch/utils/selection.ts (2026-07-27), with its
